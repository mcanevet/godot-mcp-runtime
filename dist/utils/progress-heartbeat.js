 ...
 */
export function progressTokenFrom(request) {
    const token = request.params._meta
        ?.progressToken;
    return token;
}
/**
 ...
 */
export function startProgressHeartbeat(extra, request, intervalMs = DEFAULT_HEARTBEAT_INTERVAL_MS) {
...
//# sourceMappingURL=progress-heartbeat.js.map