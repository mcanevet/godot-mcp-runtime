 ...
 */
export type ToolHandler = (runner: GodotRunner, args: OperationParams, ctx?: McpContext) => Promise<HandlerResult> | HandlerResult;
export type ToolName = (typeof autoloadToolDefinitions | typeof nodeToolDefinitions | typeof projectToolDefinitions | typeof runtimeToolDefinitions | typeof sceneToolDefinitions | typeof validateToolDefinitions)[number]['name'];
export {};
